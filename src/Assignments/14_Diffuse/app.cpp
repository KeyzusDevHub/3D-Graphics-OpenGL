...
void SimpleShapeApplication::frame() {
    ...
    OGL_CALL(glBufferSubData(GL_UNIFORM_BUFFER, 2 * sizeof(glm::mat4) + sizeof(glm::vec4), sizeof(glm::mat4), &VM_Normal[1]));
    OGL_CALL(glBufferSubData(GL_UNIFORM_BUFFER, 2 * sizeof(glm::mat4) + 2 * sizeof(glm::vec4), sizeof(glm::mat4), &VM_Normal[2]));

    // Sending Lights attributes to uniform buffer
    ...
    // For loop sending PointLights to uniform buffer
    for (auto l: lights_){
